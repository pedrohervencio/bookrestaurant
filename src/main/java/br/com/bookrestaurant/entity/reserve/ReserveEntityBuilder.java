...
public class ReserveEntityBuilder {
    ...
    public ReserveEntityBuilder addInfos(UUID restaurantId, LocalDateTime date, Integer seats) {
        this.reserveEntity = Optional.of(new ReserveEntity(restaurantId, date, seats));
        return this;
    }
